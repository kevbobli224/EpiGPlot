...
## Contributions
The `plotEpigeneticEV` function uses `ggplot` and `ggrepel` packages to perform plotting functions, as well as `grDevices` packages for the `layoutEpigeneticEV` function to parse and validate hexadecimal colour strings.
